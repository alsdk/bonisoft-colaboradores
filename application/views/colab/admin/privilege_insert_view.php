	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>It allows for unlimited custom user privileges to be defined. The privileges can then be assigned to users on an individual basis.</p>
					...
					<fieldset>
						...
						<ul>
							<li>
								...
								<input type="submit" name="insert_privilege" id="submit" value="Enviar" class="link_button large"/>
							</li>
						</ul>
					</fieldset>
				<?php echo form_close();?>
