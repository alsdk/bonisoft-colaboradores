	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>Display a pagninated list of all user accounts and then apply a search filter to find specific users via their email address or first and last name. In addition, the page demonstrates how to mass update or delete multiple accounts at the same time.</p>
			</div>		
		</div>
	</div>
							...
							<tr>
								<td>
									<a href="<?php
                                                                              /**
                                                                               * @author Jose Miguel 
                                                                               * @description habia un fallo en este enlace ya que $base_url apunta a localhost
                                                                               * cuando estamos en producci�n, encontrado que el fallo viene 
                                                                               * por usar esta variable en lugar de la funcion de CodeIgniter
                                                                               * base_url().
                                                                               * 
                                                                               * error: echo $base_url.'auth_admin/update_user_account/'.$user[$this->flexi_auth->db_column('user_acc', 'id')];?>">
                                                                               */
                                                                                    echo base_url() . 'auth_admin/update_user_account/'.$user[$this->flexi_auth->db_column('user_acc', 'id')];?>">
