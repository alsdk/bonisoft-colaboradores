	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>When a user logs into their account, the BONISOFT COLLABORATORS app authenticates their credentials are valid and then sets data into their current session related to their login method, user group and user privileges.</p>
