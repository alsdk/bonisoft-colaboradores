				...
				<?php echo form_open(current_url());	?>  	
					<div class="w100 frame">
						<ul>
							...
							<li class="info_req">
								<label for="new_password">New Contrase&ntilde;a:</label>
								<input type="password" id="new_password" name="new_password" value=""/>
							</li>
							<li class="info_req">
								<label for="confirm_new_password">Confirm New Contrase&ntilde;a:</label>
								<input type="password" id="confirm_new_password" name="confirm_new_password" value=""/>
							</li>
							<li class="info_req">
								<label for="submit">Change Contrase&ntilde;a:</label>
								<input type="submit" name="change_forgotten_password" id="submit" value="Enviar" class="link_button large"/>
							</li>
						</ul>
					</div>
				<?php echo form_close();?>
