...
<div id="body_wrap">
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				<h2>Public: Insert New Direcci&oacute;n</h2>
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			<div class="col100">
				<h2>Insert New Direcci&oacute;n</h2>
			...
			<?php } ?>
				...
				<?php echo form_open(current_url());	?>
					...
					<fieldset>
						<legend>Insert New Direcci&oacute;n</legend>
						<ul>
							<li>
							...
							<li>
								<hr/>
								<label for="submit">Insert Direcci&oacute;n:</label>
								<input type="submit" name="insert_address" id="submit" value="Enviar" class="link_button large"/>
							</li>
						</ul>
					</fieldset>
				<?php echo form_close();?>
