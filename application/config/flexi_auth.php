...
* Rob Hussey,  flexiauth@haseydesign.com
...
*/
	...
	*/ 
	 ...
	 *
	 * Note: No custom tables are required to use flexi auth and the custom 'User Profile' and 'User Direcci&oacute;n' tables below are set only as examples.
	*/
	...
	*/ 
	$config['database']['custom']['user_profile']['table'] = 'collaborators_user_profiles';
	$config['database']['custom']['user_profile']['primary_key'] = 'upro_id';
	$config['database']['custom']['user_profile']['foreign_key'] = 'upro_uacc_fk';
	$config['database']['custom']['user_profile']['join'] = 'collaborators_user_profiles.upro_uacc_fk';
	$config['database']['custom']['user_profile']['custom_columns'] = array(
//		'upro_first_name','upro_last_name','upro_address','upro_city', 'upro_country'
// Comentamos línea y modificamos añadiendo campos nuevos
                'upro_first_name','upro_last_name','upro_address','upro_postal_code','upro_city', 'upro_country','upro_asoc_id','upro_descuento','upro_comision'
	);
	 ...
	 * Para salvar los recibos generados y poder mostrar el historico a los colaboradores
         * 
         * @todo: cambiar los campos
	*/ 
	$config['database']['custom']['user_address']['table'] = 'collaborators_receipts';
	$config['database']['custom']['user_address']['primary_key'] = 'uadd_id';
	$config['database']['custom']['user_address']['foreign_key'] = 'uadd_uacc_fk';
	$config['database']['custom']['user_address']['join'] = 'collaborators_receipts.uadd_uacc_fk';
...
// Comentamos línea y modificamos añadiendo campos nuevos
        $config['database']['settings']['search_user_cols'] = array('upro_id', 'uacc_email', 'upro_first_name', 'upro_last_name', 'upro_city', 'upro_country');
	...
	*/
	$config['security']['login_session_expire'] = 0;//60*60*3;
	...
	*/
	$config['security']['static_salt'] = 'change-me!';//'BONISOFT-2014'; //COLLABORATORS NO CAMBIAR
	
	/**
	 * Set whether a salt is stored in the database and then used for password and hash token generation.
	 * @param bool
	*/
	$config['security']['store_database_salt'] = FALSE;//TRUE;
	...
	*/
	$config['security']['expire_forgotten_password'] = 0;//15;
	...
	*/
	$config['security']['recaptcha_public_key']  = '6LdQzu0SAAAAALEmGF5g9uCSOvB-lYpiQOc9fTpH';
	$config['security']['recaptcha_private_key'] = '6LdQzu0SAAAAAOpbU77gSJMqzcoPSyODNgTfQ4X0'; 
	...
	*/
	$config['security']['recaptcha_language'] = 'es';//'en';
	...
	*/
	 ...
	 * This option allows admins to verify account details before enabling users.
         * @author: Jos� Miguel Bonilla
	 * @param: bool
         * @desc: puesto a true para que el MODERADOR pueda activar manualmente
         *  las cuentas de lo colaboradores
	*/
	$config['settings']['suspend_new_accounts'] = TRUE; //FALSE;
	...
	*/
	 ...
	 * @param: int
	*/
	$config['settings']['default_group_id'] = 1; // colaborador
	...
	/**
	 * Email Settings
	 * Some of the functions need to send emails to the user (i.e. 'Account Activation', 'Forgot Password' etc).
	...
	*/
	...
	$config['email']['site_title'] = "COLABORADORES de Spanishon.com";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "info@spanishon.com";
	...
	*/
	$config['email']['email_template_update_email'] = 'update_email_address.tpl.php';
        ...
        /**
	 * 'Welcome Email Colaborator' email template.
	 * Default: 'welcome_email_colaborator.tpl.php'
	*/
	$config['email']['email_template_welcome_email'] = 'welcome_email_colaborator.tpl.php';
